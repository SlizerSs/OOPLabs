...
namespace Lab8
{            
    class Mass1<T> : IMass1<T> where T : ControlElement, IMass<T>, new()
    {
        public T[] Arr { get; set; }
        public Mass1(params T[] arr)
        {
            this.Arr = arr;
        }
        public static Mass1<T> operator -(Mass1<T> M1, int a)
        {
            ...
            return new Mass1<T>(newArr);
        }
        public static Mass1<T> operator +(Mass1<T> M1, T a)
        {
